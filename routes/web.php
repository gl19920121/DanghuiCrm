...
Route::post('/resumes/create/form', 'ResumesController@form')->name('resumes.create.form');
// Route::get('/resumes/create/auto', 'ResumesController@auto')->name('resumes.create.auto');
